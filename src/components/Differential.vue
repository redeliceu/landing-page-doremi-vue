<template>
  ...
  <section id="diferenciais" class="py-20 bg-white">
    <div class="container mx-auto px-6">
      <h2 class="text-4xl font-bold text-blue-900 mb-4 text-center">Diferenciais</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div
          ...
          <div class="flex items-start mb-3">
            ...
            <div>
              <h3 class="text-xl font-bold text-blue-900 mb-2">Sistema Sucesso de Ensino</h3>
              <p class="text-gray-700">Conteúdo moderno, interdisciplinar e alinhado à BNCC.</p>
            </div>
          </div>
        </div>
        <div
          ...
          <div class="flex items-start mb-3">
            ...
            <div>
              <h3 class="text-xl font-bold text-blue-900 mb-2">Educação Financeira DSOP</h3>
              <p class="text-gray-700">Pioneirismo na região com projeto de consciência financeira desde cedo.</p>
            </div>
          </div>
        </div>
        <div
          ...
          <div class="flex items-start mb-3">
            ...
            <div>
              <h3 class="text-xl font-bold text-blue-900 mb-2">Robótica e Tecnologia</h3>
              <p class="text-gray-700">Ensino de programação, lógica e pensamento criativo.</p>
            </div>
          </div>
        </div>
        ...
        <div
          ...
          <div class="flex items-start mb-3">
            ...
            <div>
              <h3 class="text-xl font-bold text-blue-900 mb-2">Inglês desde a infância</h3>
              <p class="text-gray-700">Exposição ao idioma de forma natural e divertida.</p>
            </div>
          </div>
        </div>
        ...
        <div
          ...
          <div class="flex items-start mb-3">
            ...
            <div>
              <h3 class="text-xl font-bold text-blue-900 mb-2">Equipe Qualificada</h3>
              <p class="text-gray-700">Professores capacitados e em constante formação.</p>
            </div>
          </div>
        </div>
